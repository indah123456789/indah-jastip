...
if (!isset($_SESSION['username']) || $_SESSION['kota'] !== 'ambon') {
    ...
    header("Location: " . BASE_URL . $kota_sesuaikan . "/dtajakarta.php");
    exit();
}
...
$stmt = $pdo->prepare("
    SELECT jastipjkt.id, jastipjkt.nama_pengirim
    FROM jastipjkt
    LEFT JOIN sortirambon ON jastipjkt.id = sortirambon.id
...
// Query untuk mengambil data berdasarkan pilihan kota, rentang tanggal, dan ID yang dimulai dengan 'JKT'
$sql = "SELECT * FROM sortirambon WHERE id LIKE 'JKT%'";
$params = [];
if ($selected_kota) {
    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page">Sortir Data Jakarta</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <form method="POST" action="dtasortir.php">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <select name="id[]" class="custom-select2 form-control" multiple="multiple" style="width: 100%;">
                                        <optgroup label="Jastip jakarta tujuan Ambon">
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="sortirForm" method="POST" action="dtasortir.php">
