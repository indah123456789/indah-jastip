...
// Tambah Data untuk Tujuan Ambon
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !isset($_POST['update'])) {
    $tujuan = $_POST['tujuan'];
    $harga = $_POST['harga'];
    $asal = $_POST['asal']; // Identifikasi tabel asal (bdg atau jkt)

    $tableName = ($asal === 'bandung') ? 'bdgtujuan' : 'jkttujuan';

    $sql = "INSERT INTO $tableName (tujuan, harga) VALUES (:tujuan, :harga)";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update'])) {
    ...
    $sql = "UPDATE $tableName SET tujuan = :tujuan, harga = :harga WHERE id_tujuan = :id_tujuan";
    $stmt = $pdo->prepare($sql);
...
if (isset($_GET['delete'])) {
    ...
    $asal = $_GET['asal']; // Identifikasi tabel asal (bdg atau jkt)

    $tableName = ($asal === 'bandung') ? 'bdgtujuan' : 'jkttujuan';

    $sql = "DELETE FROM $tableName WHERE id_tujuan = :id_tujuan";
    $stmt = $pdo->prepare($sql);
...
// Fetch Data untuk ditampilkan hanya untuk tujuan Ambon
$sql_bandung = "SELECT id_tujuan, tujuan, harga, 'bandung' AS asal FROM bdgtujuan WHERE tujuan = 'Ambon'";
$stmt_bandung = $pdo->prepare($sql_bandung);
$stmt_bandung->execute();
$tujuan_data_bandung = $stmt_bandung->fetchAll(PDO::FETCH_ASSOC);

$sql_jakarta = "SELECT id_tujuan, tujuan, harga, 'jakarta' AS asal FROM jkttujuan WHERE tujuan = 'Ambon'";
$stmt_jakarta = $pdo->prepare($sql_jakarta);
$stmt_jakarta->execute();
$tujuan_data_jakarta = $stmt_jakarta->fetchAll(PDO::FETCH_ASSOC);
        ...
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <div class="col-md-6 col-sm-12">
                        <div class="title">
                            <h4>Data Harga Tujuan Bandung</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="pb-20">
                    <table class="data-table table stripe hover nowrap">
                        ...
                        <tbody>
                            <?php foreach ($tujuan_data_bandung as $row) { 
                                    ...
                                    <td>
                                        <div class='dropdown'>
                                            ...
                                            <div class='dropdown-menu dropdown-menu-right dropdown-menu-icon-list'>
                                                ...
                                                <a class="dropdown-item" href="?delete=<?php echo $row['id_tujuan']; ?>&asal=bandung" id="deleteBtn"><i class="dw dw-delete-3"></i> Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="dtatujuan.php">
                                                    <input type="hidden" name="asal" value="bandung">
                                                    <div class="row">
                                                        <div class="col-md-6">
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <div class="col-md-6 col-sm-12">
                        <div class="title">
                            <h4>Data Harga Tujuan Jakarta</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="pb-20">
                    <table class="data-table table stripe hover nowrap">
                        ...
                        <tbody>
                            <?php foreach ($tujuan_data_jakarta as $row) { 
                                $harga_rupiah = "Rp " . number_format($row['harga'], 0, ',', '.'); ?>
                                <tr>
                                    <td class='table-plus'><?php echo htmlspecialchars($row['id_tujuan'], ENT_QUOTES, 'UTF-8'); ?></td>
                                    <td><?php echo htmlspecialchars($row['tujuan'], ENT_QUOTES, 'UTF-8'); ?></td>
                                    ...
                                    <td>
                                        <div class='dropdown'>
                                            ...
                                            <div class='dropdown-menu dropdown-menu-right dropdown-menu-icon-list'>
                                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#editModal<?php echo $row['id_tujuan']; ?>"><i class="dw dw-edit2"></i> Edit</a>
                                                <a class="dropdown-item" href="?delete=<?php echo $row['id_tujuan']; ?>&asal=jakarta" id="deleteBtn"><i class="dw dw-delete-3"></i> Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <div class="modal fade" id="editModal<?php echo $row['id_tujuan']; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel<?php echo $row['id_tujuan']; ?>" aria-hidden="true">
                                    <div class="modal-dialog modal-md" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="dtatujuan.php">
                                                    <input type="hidden" name="asal" value="jakarta">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="edit_id<?php echo $row['id_tujuan']; ?>">ID Tujuan</label>
