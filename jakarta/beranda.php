...
// Ambil data dari tabel sortirambon dengan tujuan Ambon dan id yang dimulai dengan 'JKT'
$stmt = $pdo->prepare("SELECT * FROM sortirambon WHERE tujuan = :tujuan AND id LIKE 'JKT%'");
