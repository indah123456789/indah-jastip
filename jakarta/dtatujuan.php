...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !isset($_POST['update'])) {
    ...
    $sql = "INSERT INTO jkttujuan (tujuan, harga) VALUES (:tujuan, :harga)";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update'])) {
    ...
    $sql = "UPDATE jkttujuan SET tujuan = :tujuan, harga = :harga WHERE id_tujuan = :id_tujuan";
    $stmt = $pdo->prepare($sql);
...
if (isset($_GET['delete'])) {
    ...
    $sql = "DELETE FROM jkttujuan WHERE id_tujuan = :id_tujuan";
    $stmt = $pdo->prepare($sql);
