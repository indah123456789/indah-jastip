...
if (!isset($_SESSION['username']) || $_SESSION['kota'] !== 'jakarta') {
            ...
            <div class="card-box mb-30">
                ...
                <div class="pb-20">
                    <table class="data-table table stripe hover nowrap">
                        <thead>
                            <tr>
                                <th class="table-plus datatable-nosort">NO Resi</th>
                                <th>Tujuan</th>
                                <th>Nama Pengirim</th>
                                <th>No Telp</th>
                                <th>Jumlah Paket</th>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="tujuan" name="tujuan" required>
                                                <?php
                                                $sql = "SELECT id_tujuan, tujuan, harga FROM jkttujuan";
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="datetimepicker form-control" id="tgl_pengirim" name="tgl_pengirim" min="<?php echo date('Y-m-d'); ?>" required>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="edit_tujuan<?php echo $row['id']; ?>" name="tujuan" required>
                                                    <?php
                                                    $sqlTujuan = "SELECT tujuan, harga FROM jkttujuan";
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="datetimepicker form-control" id="edit_tgl_pengirim<?php echo $row['id']; ?>" name="tgl_pengirim" value="<?php echo htmlspecialchars($row['tgl_pengirim'], ENT_QUOTES, 'UTF-8'); ?>" required>
                                            </div>
                                            <div class="form-group">
